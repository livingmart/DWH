...
class   Banner extends Component {
    render() {
        ...
        return (
					<section
						className="banner-section banner-style-three banner-slider-two"
						style={{
							backgroundImage:
								"url(" + process.env.PUBLIC_URL + "/assets/Pictures/banner2-1.jpg)",
						}}
					>
						<Slider
							{...settings}
											...
											<div className="col-lg-8">
												<div className="banner-text">
													...
													<div className="btn-wrap">
														{/* <Link to="/" className="main-btn btn-filled">Get Started Now</Link> */}
