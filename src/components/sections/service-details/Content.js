                            ...
                            <div className="service-details">
                                ...
                                <div className="details-text mb-50">
                                    <div className="section-title left-border mb-40">
                                        <span className="title-tag">MASK COMPANY</span>
                                        <h2>DEDICATED FOR MEDICAL MASK WITH 25 YEARS EXPERIENCE IN THIS FIELD.</h2>
                                    </div>
                                    <p className="mb-30">Once a business owner defined the needs to take a business to the next
                                    ...
                                    <div className="feature-list">
                                        <div className="row align-items-center">
                                            ...
                                            required changes in a business.</p>
                                                    <ul>
                                                        <li><i className="fal fa-check" /> Womes Masks </li>
                                                        <li><i className="fal fa-check" /> Mens Masks</li>
                                                        <li><i className="fal fa-check" /> Safety First</li>
                                                        <li><i className="fal fa-check" /> Filtered Mask</li>
                                                    </ul>
