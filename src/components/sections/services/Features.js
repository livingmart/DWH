                        ...
                        <div className="col-lg-6 col-md-10">
                            <div className="feature-text pl-50">
                                <div className="section-title left-border mb-40">
                                    <span className="title-tag">KNOW MORE ABOUT Mask</span>
                                    <h2>WE HAVE 25 YEARS OF EXPERIENCE IN THIS FIELD</h2>
                                </div>
                                <p>One of America’s Largest Mask Retailer, Perfumania specializes in the sale of genuine designer masks and related products at discounted prices to many new IT-enabled devices and services being produced. Moreover, there is need for IT today, not just in urban areas but rural regions as well.</p>
